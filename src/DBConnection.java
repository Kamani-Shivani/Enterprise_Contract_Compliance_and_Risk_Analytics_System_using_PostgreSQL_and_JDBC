...
public class DBConnection {
    ...
    private static final String USER_NAME = "your_postgres_username";   //replace with your PostgreSQL username
    private static final String PASSWORD = "your_postgres_password";    //replace with your PostgreSQL password
